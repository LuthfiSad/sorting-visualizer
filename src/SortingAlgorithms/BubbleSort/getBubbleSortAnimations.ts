const getBubbleSortAnimations = (array: number[]): number[] => {
  const animations: number[] = []; // { comparingElement1, comparingElement2, doSwap, isFinalElement, finalElement }
