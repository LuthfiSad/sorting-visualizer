import getSelectionSortAnimations from "./getSelectionSortAnimations.js";
import {
    ...
    const promise2 = new Promise<void>((resolve) => {
      setTimeout(() => {
        if (!!isFinalElement === true) {
          ...
          changeBackgroundColor(comparingElement2, "rgba(225, 0, 0, 0.6)");
          changeBackgroundColor(minIndexElement, "rgba(225, 0, 0, 0.6)");
        }
