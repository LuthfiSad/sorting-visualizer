import CompletedEffect from "@/assets/sounds/CompletedEffect.mp3";
...
export function resetBarStyleDefault(
  ...
  setTimeout(() => {
    array.forEach((_, j) => {
      changeBackgroundColor(j, "rgba(225, 0, 0, 0.5)");
      changeBoxShadow(j, "5px 5px 50px 5px rgba(225, 0, 0, 0.2)");
    });
  }, animationSpeed);
}
